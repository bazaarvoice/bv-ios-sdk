...
/*!
 ...
 Any Comminications returned in the result will be posted as a UILocalNotification. Communications not returned are not scheduled.
 Frequency limit and delay are not honored for communications not returned.
 @param manager
