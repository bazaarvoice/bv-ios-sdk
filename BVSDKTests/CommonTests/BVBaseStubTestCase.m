...
- (void)addStubWith200ResponseForJSONFileNamed:(NSString *)resultFile {
    [self addStubWith200ResponseForJSONFileNamed:resultFile
                                 withPassingTest:nil];
}
        ...
        withStubResponse:^OHHTTPStubsResponse *(NSURLRequest *request) {
          ...
          if (callCount < fileCount) {
              ...
              if (__ISA(fileObj, NSString)) {
                  ...
                  return [[OHHTTPStubsResponse
                      responseWithFileAtPath:OHPathForFile(resultFile,
                                                           self.class)
                                  statusCode:200
                                     headers:@{
                                         @"Content-Type" :
          ...
          NSError *resourceUnavailableError =
              [NSError errorWithDomain:NSURLErrorDomain
                              ...
                              userInfo:nil];
          return
              [OHHTTPStubsResponse responseWithError:resourceUnavailableError];
        }];
}
