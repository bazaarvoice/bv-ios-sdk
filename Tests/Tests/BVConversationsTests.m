...
#define CONVERSATIONS_TEST_USING_MOCK_DATA                                     \
...
- (void)checkParams:(NSMutableDictionary *)params
  ...
  for (NSString *element in queryElements) {
    ...
    [foundParams setObject:[keyVal objectAtIndex:1]
                    forKey:[keyVal objectAtIndex:0]];
  }

  NSAssert(
      params.count == foundParams.count,
      @"Wrong number of URL params... %lu expected vs %lu found\n request:%@",
      (unsigned long)params.count, (unsigned long)foundParams.count, url);

  NSArray *keyArray = [params allKeys];
  NSUInteger count = [keyArray count];
  for (int i = 0; i < count; i++) {
    NSString *key = [keyArray objectAtIndex:i];
    NSAssert([foundParams objectForKey:key], @"Request missing parameter %@",
             key);
    NSString *requestVal = (NSString *)[foundParams objectForKey:key];
    NSString *expectedVal = (NSString *)[params objectForKey:key];
    NSAssert([requestVal isEqualToString:expectedVal],
             @"Request value of %@ does not match expected value of %@",
             requestVal, expectedVal);
  }
}
...
- (void)didReceiveResponse:(NSDictionary *)response forRequest:(id)request {
  ...
  BOOL hasErrors = [[response objectForKey:@"HasErrors"] boolValue] ||
                   ([response objectForKey:@"HasErrors"] == nil);
  BOOL missingErrorArray =
      [response objectForKey:@"Errors"] ==
      nil; // We always expect an errors array, but will be empty on success
  if (hasErrors || missingErrorArray) {
    NSLog(@"\n\n==========================\n\n");
    XCTFail(@"Error in Class: %@ \n Failure: %@", [request class],
            [response objectForKey:@"Errors"]);
    NSLog(@"\n\n==========================\n\n");
    NSLog(@"%@", response);
  } else if (!receivedProgressCallback &&
             [request isKindOfClass:[BVPost class]]) {
    // We only need to check if we received a progress callback for POST /
    // submission requests
    NSLog(@"\n\n==========================\n\n");
    XCTFail(@"Failed to receive a progress callback for request: %@",
            [request class]);
    NSLog(@"\n\n==========================\n\n");
  } else {
    XCTAssertNotNil(response, @"Invalid response for Class: %@",
                    [request class]);
  }
  NSLog(@"\n\n");
}
...
- (void)testShowReview {
  ...
  [showDisplayRequest setFilterForAttribute:@"Id"
                                   equality:BVEqualityEqualTo
                                      value:@"6601211"];
  [showDisplayRequest setFilterOnIncludedType:BVIncludeTypeProducts
                                 forAttribute:@"Id"
                                     equality:BVEqualityEqualTo
                                        value:@"009"];
  ...
  [showDisplayRequest addSortOnIncludedType:BVIncludeTypeProducts
                                  attribute:@"Id"
                                  ascending:YES];
  ...
  while (!requestComplete &&
    ...
    ;
  [self
      checkParams:[NSMutableDictionary
                      dictionaryWithObjectsAndKeys:@"Reviews", @"Stats",
                                                   @"Id:asc", @"Sort_Products",
                                                   @"Id:eq:009",
                                                   @"Filter_Products", @"10",
                                                   @"Limit_Products", @"Id:asc",
                                                   @"Sort", @"Products",
                                                   @"Include", @"0", @"Offset",
                                                   @"Id:eq:6601211", @"Filter",
                                                   @"50", @"Limit",
                                                   @"Great%20sound", @"Search",
                                                   nil]];
}
...
- (void)testShowReviewIncludesSearch {
  ...
  [self addStubWith200ResponseForJSONFileNamed:
            @"testShowReviewIncludesSearch.json"];
#endif
  ...
  [showDisplayRequest addSortOnIncludedType:BVIncludeTypeProducts
                                  ...
                                  ascending:YES];
  [showDisplayRequest
      setSearchOnIncludedType:BVIncludeTypeProducts
                       search:@"Increase your potential to shine"];
  [showDisplayRequest sendRequestWithDelegate:self];
  ...
  while (!requestComplete &&
         [theRL runMode:NSDefaultRunLoopMode beforeDate:[NSDate distantFuture]])
    ;
  [self checkParams:[NSMutableDictionary
                        dictionaryWithObjectsAndKeys:
                            @"Id:asc", @"Sort_Products", @"Id:asc", @"Sort",
                            @"Products", @"Include",
                            @"Increase%20your%20potential%20to%20shine",
                            @"Search_Products", nil]];
}
...
- (void)testShowQuestions {
  ...
  [self
      checkParams:[NSMutableDictionary
                      dictionaryWithObjectsAndKeys:@"Answers", @"Stats",
                                                   @"Id:asc", @"Sort_Products",
                                                   @"Id:eq:test0",
                                                   @"Filter_Products", @"10",
                                                   @"Limit_Products", @"Id:asc",
...
- (void)testShowStorySparse {
  ...
  while (!requestComplete &&
    ...
    ;
  [self checkParams:[NSMutableDictionary
                        dictionaryWithObjectsAndKeys:@"Id:eq:14181", @"Filter",
                                                     nil]];
}
...
- (void)testShowStory {
  ...
  [showDisplayRequest setFilterForAttribute:@"Id"
                                   equality:BVEqualityEqualTo
                                      value:@"14181"];
  [showDisplayRequest setFilterOnIncludedType:BVIncludeTypeComments
                                 forAttribute:@"Id"
                                     equality:BVEqualityEqualTo
                                        value:@"1010"];
  ...
  showDisplayRequest.offset = 0;
  [showDisplayRequest addSortForAttribute:@"Id" ascending:YES];
  [showDisplayRequest addSortOnIncludedType:BVIncludeTypeComments
                                  attribute:@"Id"
                                  ascending:YES];
  ...
  [self
      checkParams:[NSMutableDictionary
                      dictionaryWithObjectsAndKeys:@"Stories", @"Stats",
                                                   @"Id:asc", @"Sort_Comments",
                                                   @"Id:eq:1010",
                                                   @"Filter_Comments", @"10",
                                                   @"Limit_Comments", @"Id:asc",
                                                   @"Sort", @"Comments",
                                                   @"Include", @"0", @"Offset",
                                                   @"Id:eq:14181", @"Filter",
                                                   @"50", @"Limit", nil]];
...
- (void)testShowCommentsSparse {
  ...
  BVGet *showDisplayRequest =
      [[BVGet alloc] initWithType:BVGetTypeReviewCommments];
  [showDisplayRequest sendRequestWithDelegate:self];
...
- (void)testShowComments {
  ...
  BVGet *showDisplayRequest =
      [[BVGet alloc] initWithType:BVGetTypeReviewCommments];
  [showDisplayRequest setFilterForAttribute:@"ReviewId"
                                   equality:BVEqualityEqualTo
                                      value:@"6597809"];
  [showDisplayRequest setFilterOnIncludedType:BVIncludeTypeProducts
                                 forAttribute:@"Id"
...
#if CONVERSATIONS_TEST_USING_MOCK_DATA == 1
  [self addStubWith200ResponseForJSONFileNamed:
            @"testShowCommentStorySparse.json"];
#endif

  BVGet *showDisplayRequest =
      [[BVGet alloc] initWithType:BVGetTypeStoryCommments];
  [showDisplayRequest sendRequestWithDelegate:self];
...
- (void)testShowCommentStory {
  ...
  BVGet *showDisplayRequest =
      [[BVGet alloc] initWithType:BVGetTypeStoryCommments];
  [showDisplayRequest setFilterForAttribute:@"StoryId"
                                   equality:BVEqualityEqualTo
                                      value:@"967"];
  [showDisplayRequest setFilterOnIncludedType:BVIncludeTypeProducts
                                 forAttribute:@"Id"
...
- (void)testShowProfile {
  ...
  BVGet *showDisplayRequest = [[BVGet alloc] initWithType:BVGetTypeAuthors];
  [showDisplayRequest setFilterForAttribute:@"TotalCommentCount"
                                   equality:BVEqualityGreaterThanOrEqual
                                      value:@"0"];
  [showDisplayRequest setFilterForAttribute:@"Id"
                                   equality:BVEqualityEqualTo
                                      value:@"smartPP"];
...
- (void)testShowProducts {
  ...
  BVGet *showDisplayRequest = [[BVGet alloc] initWithType:BVGetTypeProducts];
  [showDisplayRequest setFilterForAttribute:@"CategoryId"
                                   equality:BVEqualityEqualTo
                                      value:@"testcategory1011"];
  [showDisplayRequest setFilterOnIncludedType:BVIncludeTypeReviews
                                 forAttribute:@"Id"
                                     equality:BVEqualityEqualTo
                                        value:@"83501"];
  ...
  showDisplayRequest.offset = 0;
  [showDisplayRequest addSortForAttribute:@"Id" ascending:YES];
  [showDisplayRequest addSortOnIncludedType:BVIncludeTypeReviews
                                  attribute:@"Id"
                                  ascending:YES];
  [showDisplayRequest addStatsOn:BVIncludeStatsTypeReviews];
  [showDisplayRequest sendRequestWithDelegate:self];
  ...
  [self checkParams:[NSMutableDictionary
                        dictionaryWithObjectsAndKeys:
                            @"Reviews", @"Stats", @"Id:asc", @"Sort_Reviews",
                            @"Id:eq:83501", @"Filter_Reviews", @"10",
                            @"Limit_Reviews", @"Id:asc", @"Sort", @"Reviews",
                            @"Include", @"0", @"Offset",
                            @"CategoryId:eq:testcategory1011", @"Filter", @"10",
                            @"Limit", nil]];
}
...
- (void)testShowStatistics {
  ...
  [showDisplayRequest
      setFilterForAttribute:@"ProductId"
                   equality:BVEqualityEqualTo
                     values:[NSArray arrayWithObjects:@"test1", @"test2",
                                                      @"test3", nil]];
  [showDisplayRequest addStatsOn:BVIncludeStatsTypeReviews];
  ...
  [self checkParams:[NSMutableDictionary
                        dictionaryWithObjectsAndKeys:
                            @"ProductId:eq:test1,test2,test3", @"Filter",
                            @"Reviews,NativeReviews", @"Stats", nil]];
}
    ...
    return [request.URL.host containsString:@"bazaarvoice.com"];
      ...
      withStubResponse:^OHHTTPStubsResponse *(NSURLRequest *request) {
        ...
        return [[OHHTTPStubsResponse
            responseWithFileAtPath:OHPathForFile(@"testShowStatistics.json",
                                                 self.class)
                        statusCode:200
                           headers:@{
                             @"Content-Type" :
...
// A Note on test stubs for POST from:
// https://github.com/AliSoftware/OHHTTPStubs#Known_limitations
...
has been loaded), so any data in the HTTPBody or HTTPBodyStream of an
NSURLRequest, or data provided to -[NSURLSession
uploadTaskWithRequest:fromData:]; will be ignored, and more importantly, the
...
- (void)testSubmissionReview {
  ...
  [request addPhotoUrl:@"https://apitestcustomer.ugc.bazaarvoice.com/bvstaging/"
                       @"5555/ps_amazon_s3_3rgg6s4xvev0zhzbnabyneo21/photo.jpg"
           withCaption:nil];
...
- (void)testSubmissionReviewBackgroundThread {
  ...
  dispatch_async(
      dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
        ...
        request.reviewText = @"Some kind of review text.";
        request.userNickname = @"testnickname";
        [request addPhotoUrl:@"https://apitestcustomer.ugc.bazaarvoice.com/"
                             @"bvstaging/5555/"
                             @"ps_amazon_s3_3rgg6s4xvev0zhzbnabyneo21/photo.jpg"
                 withCaption:nil];
        [request addVideoUrl:@"https://www.youtube.com" withCaption:nil];
...
- (void)testSubmissionStoryCommentsHostedAuth {
  ...
  // For Hosted Auth, we use a separately configured key. Keys can be configured
  // for either anonymous posting with a user ID, or use the hostedAuth*
  // parameters to specify the callback URL and authorization email.
  [BVSDKManager sharedManager].apiKeyConversations =
      @"95fczpcfxcetspeg388pbrvy";
  [BVSDKManager sharedManager].staging = YES;
  ...
  request.reviewText = @"This is a test for hosted authentication where we "
                       @"will send a post review email for the customer to "
                       @"verify their input.";

  request.hostedAuthCallbackUrl =
      @"https://apitestcustomer.ugc.bazaarvoice.com/bvstaging";
...
- (void)testSubmissionStoryCommentsAuthenticatedUser {
  ...
  // For Hosted Auth, we use a separately configured key. Once a user is
  // confirmed and authenticated we can simply use the authentication string to
  // allow the user to post reviews without confirmation.
  [BVSDKManager sharedManager].apiKeyConversations =
      @"95fczpcfxcetspeg388pbrvy";
  [BVSDKManager sharedManager].staging = YES;
  [BVSDKManager sharedManager].clientId = @"bv-mobilesdk";
  ...
  BVPost *request = [[BVPost alloc] initWithType:BVPostTypeReview];
  request.commentText = @"This is a test comment for hosted authentication. In "
                        @"this case we use the authention token.";
  request.productId = @"967";
  request.authenticatedUser =
      @"6ed12da604cc75b8613f7e209d07987b696e7465726e616c5f7375626d7373696f6e3d7"
      @"4727565267573657269643d616a6d66716176737836786f7068626e7571656474726a34"
      @"7a26757365726e616d653d617069686f73746175746873756274657374657226686f737"
      @"465643d564552494649454426646174653d3230313430353036266d61786167653d3336"
      @"35";
...
//     NSRunLoop *theRL = [NSRunLoop currentRunLoop];
//     // Begin a run loop terminated when the requestComplete it set to true
//     while (!requestComplete && [theRL runMode:NSDefaultRunLoopMode
...
- (void)testSubmissionPhotos {
  ...
  BVMediaPost *mySubmission =
      [[BVMediaPost alloc] initWithType:BVMediaPostTypePhoto];
...
- (void)testSubmissionVideo {
  ...
  BVMediaPost *mySubmission =
      [[BVMediaPost alloc] initWithType:BVMediaPostTypeVideo];
  mySubmission.contentType = BVMediaPostContentTypeReview;
  mySubmission.userId = @"123";
...
- (void)testSubmissionFeedback2 {
  ...
  mySubmission.reasonText = @"This post was not nice.";
  [mySubmission sendRequestWithDelegate:self];
  [mySubmission sendRequestWithDelegate:self];
...
- (void)testParamsAttached {
  ...
  mySubmission.userId =
      [NSString stringWithFormat:@"WHEEEEMYNAMEISSAME%i", arc4random()];
  mySubmission.rating = 5;
  mySubmission.title = @"Test title";
  mySubmission.reviewText = @"Some kind of review text. Some kind of review "
                            @"text. Some kind of review text. Some kind of "
                            @"review text. Some kind of review text. Some kind "
                            @"of review text. Some kind of review text. Some "
                            @"kind of review text. Some kind of review text.";
  mySubmission.userNickname = @"testnickname4";
  [mySubmission
      addPhotoUrl:@"https://apitestcustomer.ugc.bazaarvoice.com/bvstaging/5555/"
                  @"ps_amazon_s3_3rgg6s4xvev0zhzbnabyneo21/photo.jpg"
      withCaption:nil];
  [mySubmission
      addPhotoUrl:@"https://apitestcustomer.ugc.bazaarvoice.com/bvstaging/5555/"
                  @"ps_amazon_s3_a11b8t4wlgb914fjaiudaadvo/photo.jpg"
      withCaption:@"This photo is cool!"];
  [mySubmission
      addPhotoUrl:@"https://apitestcustomer.ugc.bazaarvoice.com/bvstaging/5555/"
                  @"ps_amazon_s3_5ugnhmmq24p1q35tlygrqalz9/photo.jpg"
      withCaption:nil];
