...
- (void)submit:(nonnull FeedbackSubmissionCompletion)success
  ...
  [self submitFeedbackWithCompletion:^(
...
- (void)
submitFeedbackWithCompletion:(nonnull FeedbackSubmissionCompletion)success
                     failure:(nonnull ConversationsFailureHandler)failure {
  NSDictionary *parameters = [self createSubmissionParameters];
  NSData *postBody = [self transformToPostBody:parameters];

  NSString *urlString =
      [NSString stringWithFormat:@"%@submitfeedback.json",
        ...
        completionHandler:^(NSData *data, NSURLResponse *response,
          ...
          @try {
            ...
            if (httpError) {
              ...
              BVFeedbackSubmissionResponse *response =
                  [[BVFeedbackSubmissionResponse alloc]
