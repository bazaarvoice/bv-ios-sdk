...
/**
 Class to use to submit a review on a store to the Bazaarvoice platform.
 Requires that you have set the apiKeyConversationsStore value in the
 BVSDKManager and client id before you begin using submission request.

 Of the many parameters possible on a BVStoreReviewSubmission, the ones needed
 for submission depend on your specific implementation.
