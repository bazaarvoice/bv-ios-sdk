...
/**
    ...
    This collection view should be used in combination with
   `BVRecommendationCollectionViewCell` cells.
 */
@interface BVProductRecommendationsCollectionView
    : UICollectionView <BVRecommendationsContainerProtocol>
...
/**
    ...
    This table view should be used in combination with
   `BVRecommendationTableViewCell` cells.
 */
@interface BVProductRecommendationsTableView
    : UITableView <BVRecommendationsContainerProtocol>
...
/**
   ...
   or table view. For this case, use `BVProductRecommendationsCollectionView` or
   `BVProductRecommendationsTableView`.

    This container is meant to hold static, non-scrolling product
   recommendations. You should create one or more `BVProductRecommendationView`
   views and add them to this container view.
 */
@interface BVProductRecommendationsContainer
    : UIView <BVRecommendationsContainerProtocol>
