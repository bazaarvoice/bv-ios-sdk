...
/// Singleton class that manages all analytic event queueing and dispatching of
/// events to Bazaarvoice.
...
/// Set to YES to only log analytic events and not send to server. Defaults to
/// NO
...
/**
   ...
   queue than other impression events.
...
/**
    ...
    @return The string representation of the date that can be sent along with a
   BV analytic event.
 */
...
/**
    Get mobile diagnostic event dictionary to add to an event. Provides info
   such as bundle identifier, app version, ect.
