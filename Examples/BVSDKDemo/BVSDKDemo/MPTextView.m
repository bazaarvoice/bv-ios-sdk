...
static CGFloat const kLabelLeftOffset = 5.f;
...
// The top offset differs when the view is instantiated from IB or
// programmatically. Use this to track the instantiation route and offset the
// label accordingly.
...
- (CGRect)placeholderLabelFrameWithOffset:(CGSize)labelOffset {
  return CGRectMake(labelOffset.width, labelOffset.height,
...
- (void)removeDictationResultPlaceholder:(id)placeholder
  ...
  // Call super.
  [super removeDictationResultPlaceholder:placeholder
