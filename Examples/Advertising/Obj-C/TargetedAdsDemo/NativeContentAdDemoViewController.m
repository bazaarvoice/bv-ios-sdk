...
@interface NativeContentAdDemoViewController () <
...
- (void)viewDidLoad {
  ...
  self.adLoader =
      [[GADAdLoader alloc] initWithAdUnitID:@"/6499/example/native"
...
- (void)adLoader:(GADAdLoader *)adLoader
  ...
  contentAdView.frame = CGRectMake(padding, self.view.bounds.size.height * 0.18,
