...
- (void)viewDidLoad {
    ...
    [self.demoStatsTableView registerNib:[UINib nibWithNibName:@"StatisticTableViewCell" bundle:nil] forCellReuseIdentifier:@"StatisticTableViewCell"];
        ...
        case ReviewStats:
            ...
            switch (indexPath.row) {
                case TotalReviewCount:
                    ...
                    cell.statValueLabel.text = [self.reviewStatistics.totalReviewCount stringValue];
                    break;

                case AverageOverallRating:
                    cell.statTypeLabel.text = @"Average Overall Rating";
                    cell.statValueLabel.text = [self.reviewStatistics.averageOverallRating stringValue];
                    break;
                    
                case HelpfulVoteCount:
                    cell.statTypeLabel.text = @"Helpful Vote Count";
                    cell.statValueLabel.text = [self.reviewStatistics.helpfulVoteCount stringValue];
                    break;
                    
                case NotHelpfulVoteCount:
                    cell.statTypeLabel.text = @"Not Helpful Vote Count";
                    cell.statValueLabel.text = [self.reviewStatistics.notHelpfulVoteCount stringValue];
                    break;
                    
                case RecommendedCount:
                    cell.statTypeLabel.text = @"Recommended Count";
                    cell.statValueLabel.text = [self.reviewStatistics.recommendedCount stringValue];
                    break;
                    
                case NotRecommendedCount:
                    cell.statTypeLabel.text = @"Not Recommended Count";
                    cell.statValueLabel.text = [self.reviewStatistics.notRecommendedCount stringValue];
                    break;
                    
                case OverallRatingRange:
                    cell.statTypeLabel.text = @"Overall Rating Range";
                    cell.statValueLabel.text = [self.reviewStatistics.overallRatingRange stringValue];
                    break;
        ...
        case QAStats:
            ...
            switch (indexPath.row) {
                case TotalQuestions:
                    ...
                    cell.statValueLabel.text = [self.questionAnswerStats.totalQuestionCount stringValue];
                    break;
                
                case TotalAnswers:
                    cell.statTypeLabel.text = @"Total Answers";
                    cell.statValueLabel.text = [self.questionAnswerStats.totalAnswerCount stringValue];
                    break;
                    
                case AnswerHelpfulVoteCount:
                    cell.statTypeLabel.text = @"Answer Helpful Vote Count";
                    cell.statValueLabel.text = [self.questionAnswerStats.answerHelpfulVoteCount stringValue];
                    break;
                    
                case AnswerNotHelpfulVoteCount:
                    cell.statTypeLabel.text = @"Answer Not Helpful Vote Count";
                    cell.statValueLabel.text = [self.questionAnswerStats.answerNotHelpfulVoteCount stringValue];
                    break;
                    
                case QuestionHelpfulVoteCount:
                    cell.statTypeLabel.text = @"Question Helpful Vote Count";
                    cell.statValueLabel.text = [self.questionAnswerStats.questionHelpfulVoteCount stringValue];
                    break;
                    
                case QuestionNotHelpfulVoteCount:
                    cell.statTypeLabel.text = @"Question Not Helpful Vote Count";
                    cell.statValueLabel.text = [self.questionAnswerStats.questionNotHelpfulVoteCount stringValue];
                    break;
