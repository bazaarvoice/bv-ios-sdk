...
@property(weak, nonatomic)
    IBOutlet BVProductRecommendationsCollectionView *recommendationsView;
...
- (void)viewDidLoad {
  ...
  [self.recommendationsView
                     registerNib:[UINib nibWithNibName:@"DemoCell" bundle:nil]
...
// Fetch the product recommenations from the API method on the
// BVRecommendationsCollectionView container.
...
- (void)viewWillLayoutSubviews {
  ...
  UICollectionViewFlowLayout *layout =
      (UICollectionViewFlowLayout *)
          self.recommendationsView.collectionViewLayout;

  layout.scrollDirection = UICollectionViewScrollDirectionHorizontal;
  layout.itemSize = CGSizeMake(self.recommendationsView.bounds.size.width / 2,
                               self.recommendationsView.bounds.size.width / 2);
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView
  ...
  DemoCell *cell = [collectionView
      dequeueReusableCellWithReuseIdentifier:@"DemoCellIdentifier"
