...
-(id)init {
    ...
    return [super initWithMemoryCapacity:(2*1024*1024) diskCapacity:0 diskPath:@"com.bv.recs.cache"];
...
-(NSCachedURLResponse *)cachedResponseForRequest:(NSURLRequest *)request {
    ...
    if (cachedResponse) {
        ...
        if ([cacheDate timeIntervalSinceNow] < -(_cacheMaxAgeInSeconds) || cacheDate == nil) {
...
- (void)printCacheSize{
    ...
    [[BVLogger sharedLogger] verbose:[NSString stringWithFormat:@"NSURLCache Memory/Disk Size: %ld/%ld (bytes)", (unsigned long)[self currentMemoryUsage], (unsigned long)[self currentDiskUsage]]];
