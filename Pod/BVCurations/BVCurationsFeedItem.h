...
/// As provided by the external ID BVCurationsFeedParams value. When supplied,
/// this is used as the product Id for analytics reporting.
...
- (id)initWithDict:(NSDictionary *)dict
    withReferencedProducts:(NSDictionary *)referencedProducts
            withExternalId:(NSString *)exernalId;
...
/// Lat/Long coordinates for a given BVCurationsFeedItem objects. Items may be
/// nil.
...
/// Attributes for a single product reference. This object is referenced by a
/// single BVCurationsFeedItem and can be used to show the user the related
/// items and how to buy it.
