...
/**
 *  Provided an authenticated user has been set in the updateProfile method, this utility provides a dictionary of the interests and brands in the customer's profile and the relative weights of those interests and brands.
 *
 *  @return A dictionary of interests and brands for an authenticated customer.
 */
