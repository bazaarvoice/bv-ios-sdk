...
- (id)initWithDictionary:(NSDictionary *)configDict{
    ...
    SET_DEFAULT_IF_NULL(_reviewPromtNoReview, [configDict objectForKey:@"reviewPromtNoReview"], @"No Thanks.");
    SET_DEFAULT_IF_NULL(_reviewPromptRemindText, [configDict objectForKey:@"reviewPromptRemindText"], @"Remind Me Later");
