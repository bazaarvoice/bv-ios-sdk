...
@property (nonatomic, strong) BVStoreReviewNotificationProperties *notificationProps;
@end
...
- (void)didReceiveNotification:(UNNotification *)notification {
    ...
    _notificationProps = [[BVStoreReviewNotificationProperties alloc] initWithDictionary:notification.request.content.userInfo[USER_INFO_CONFIG_PROPS]];
