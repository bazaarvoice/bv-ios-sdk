...
@property(nonatomic, strong)
    BVStoreReviewNotificationProperties *notificationProps;
@end
...
- (void)viewDidLoad {
  ...
  [_constrainingView setContentHuggingPriority:UILayoutPriorityRequired
                                       forAxis:UILayoutConstraintAxisVertical];
  [self.view
      addConstraint:[NSLayoutConstraint constraintWithItem:_constrainingView
  ...
  [self.view addConstraint:[NSLayoutConstraint
                               constraintWithItem:_constrainingView
  ...
  NSLayoutConstraint *height =
      [NSLayoutConstraint constraintWithItem:_constrainingView
...
- (void)didReceiveNotification:(UNNotification *)notification {
  ...
  _notificationProps = [[BVStoreReviewNotificationProperties alloc]
      initWithDictionary:notification.request.content
                             .userInfo[USER_INFO_CONFIG_PROPS]];
  MKCoordinateRegion region;
  region.center.latitude =
      [notification.request.content.userInfo[USER_INFO_LAT] floatValue];
  region.center.longitude =
      [notification.request.content.userInfo[USER_INFO_LONG] floatValue];
  region.span.latitudeDelta =
      [notification.request.content.userInfo[USER_INFO_LAT_DELTA] floatValue];
  region.span.latitudeDelta =
      [notification.request.content.userInfo[USER_INFO_LONG_DELTA] floatValue];
