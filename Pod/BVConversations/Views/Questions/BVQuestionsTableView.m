...
@interface BVQuestionsTableView()<UITableViewDelegate, UITableViewDataSource>{
...
-(void)tryToSendInViewEvent {
    ...
    if (hasEnteredView && productId != nil) {
        if (!hasSentInViewEvent){
            ...
            [BVConversationsAnalyticsUtil queueAnalyticsEventForQuestionContainerInView:productId];
        }
    }
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if([cell isKindOfClass:[BVQuestionTableViewCell class]]) {
        ...
        if(question != nil){
            ...
            NSString* message = @"BVQuestionTableViewCell has nil `question` property. This must be set in `cellForItemAtIndexPath`.";
...
-(void)scrollViewWillBeginDragging:(UIScrollView *)scrollView {
    ...
    if(!hasSentScrollEvent) {
        ...
        [BVConversationsAnalyticsUtil queueAnalyticsEventForUGCScrollEvent:ScrollTypeQuestionsTable productId:productId];
    }
