...
-(nullable instancetype)initWithApiResponse:(nullable id)apiResponse {
    ...
    if(self){
        ...
        SET_IF_NOT_NULL(self.authorSubmissionToken, apiObject[@"AuthorSubmissionToken"])
        
        self.errors = [BVConversationsError createErrorListFromApiResponse:apiObject[@"Errors"]];
        self.fieldErrors = [BVFieldError createListFromFormErrorsDictionary:apiObject[@"FormErrors"]];
