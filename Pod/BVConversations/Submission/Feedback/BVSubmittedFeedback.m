...
-(nullable instancetype)initWithFeedbackResponse:(nullable id)inapropriateDict {
    self = [super init];
    if(self){
        
        if(inapropriateDict == nil || ![inapropriateDict isKindOfClass:[NSDictionary class]]){
            return nil;
        }
...
-(nullable instancetype)initWithFeedbackResponse:(nullable id)helpfulnessDict {
    ...
    if(self){
        ...
        if(helpfulnessDict == nil || ![helpfulnessDict isKindOfClass:[NSDictionary class]]){
            return nil;
        }
...
-(nullable instancetype)initWithApiResponse:(nullable id)apiResponse {
    ...
    if(self){
        ...
        if (apiObject){
            self.inappropriateResponse = [[BVFeedbackInappropriateResponse alloc] initWithFeedbackResponse:apiObject];
            self.helpfulnessResponse = [[BVFeedbackHelpfulnessResponse alloc] initWithFeedbackResponse:apiObject];
        } else {
            return nil;
        }
