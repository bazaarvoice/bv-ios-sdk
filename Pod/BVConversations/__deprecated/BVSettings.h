 ...
 */
__deprecated_msg("BVSettings has been deprecated and will be removed in a future release - use BVSDKManager instead. Please see the github documentation for recommended use of this SDK.")
