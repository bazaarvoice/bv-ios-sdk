 ...
 */
__deprecated_msg("BVPost has been deprecated and will be removed in a future release. To submit content, use the following submission objects: BVReviewSubmission, BVQuestionSubmission, BVAnswerSubmission. Please see the github documentation for recommended use of this SDK.")
