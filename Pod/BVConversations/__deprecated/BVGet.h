 ...
 */
__deprecated_msg("BVGet has been deprecated and will be removed in a future release. To retreive content, use the following request objects: BVProductDisplayPageRequest, BVReviewsRequest, BVQuestionsRequest, BVBulkRatingsRequest. Please see the github documentation for recommended use of this SDK.")
