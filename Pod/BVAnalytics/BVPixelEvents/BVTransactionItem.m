...
- (NSDictionary *)toRaw{
    ...
    [eventDict setObject:[NSString stringWithFormat:@"%d", self.quantity] forKey:@"quantity"];
    [eventDict setObject:[NSString stringWithFormat:@"%0.2f", self.price] forKey:@"price"];
