...
//
// This file defines all Contextual Interest Tier 1 and Contextual Interest Tier
// 2 interest strings.
// These values can be fed into BVAdsSDK via various location-powered methods
// defined in BVAdsSDK.h
...
static BVContextualInterest *tierOneTechnologyAndComputing =
    @"technologyandcomputing";
static BVContextualInterest *tierOneApparelAndAccessories =
...
static BVContextualInterest *tierOneArtsAndEntertainment =
...
static BVContextualInterest *tierTwoTravelAustraliaAndNewZealand =
    @"australiaandnewzealand";
static BVContextualInterest *tierTwoTravelBedAndBreakfasts =
    @"bedandbreakfasts";
...
static BVContextualInterest *tierTwoTravelHoneymoonsGetaways =
    @"honeymoonsgetaways";
...
static BVContextualInterest *tierTwoTravelMexicoAndCentralAmerica =
...
static BVContextualInterest *tierTwoTravelTravelingwithKids =
    @"travelingwithkids";
...
static BVContextualInterest *tierTwoFamilyAndParentingBabiesAndToddlers =
    @"babiesandtoddlers";
static BVContextualInterest *tierTwoFamilyAndParentingDaycarePreSchool =
    @"daycarepreschool";
static BVContextualInterest *tierTwoFamilyAndParentingEldercare = @"eldercare";
static BVContextualInterest *tierTwoFamilyAndParentingFamilyInternet =
    @"familyinternet";
static BVContextualInterest *tierTwoFamilyAndParentingParentingK6Kids =
    @"parentingk6kids";
static BVContextualInterest *tierTwoFamilyAndParentingParentingTeens =
    @"parentingteens";
static BVContextualInterest *tierTwoFamilyAndParentingPregnancy = @"pregnancy";
static BVContextualInterest *tierTwoFamilyAndParentingSpecialNeedsKids =
    @"specialneedskids";

/// Contextual Interests Tier 2: Technology & Computing
static BVContextualInterest *tierTwoTechnologyAndComputing3DGraphics =
    @"3dgraphics";
static BVContextualInterest *tierTwoTechnologyAndComputingAnimation =
    @"animation";
static BVContextualInterest *tierTwoTechnologyAndComputingAntivirusSoftware =
    @"antivirussoftware";
static BVContextualInterest *tierTwoTechnologyAndComputingCC = @"cc";
static BVContextualInterest *tierTwoTechnologyAndComputingCamerasAndCamcorders =
    @"camerasandcamcorders";
static BVContextualInterest *tierTwoTechnologyAndComputingCellPhones =
    @"cellphones";
static BVContextualInterest
    *tierTwoTechnologyAndComputingComputerCertification =
        @"computercertification";
static BVContextualInterest *tierTwoTechnologyAndComputingComputerNetworking =
    @"computernetworking";
static BVContextualInterest *tierTwoTechnologyAndComputingComputerPeripherals =
    @"computerperipherals";
static BVContextualInterest *tierTwoTechnologyAndComputingComputerReviews =
    @"computerreviews";
static BVContextualInterest *tierTwoTechnologyAndComputingDataCenters =
    @"datacenters";
static BVContextualInterest *tierTwoTechnologyAndComputingDatabases =
    @"databases";
static BVContextualInterest *tierTwoTechnologyAndComputingDesktopPublishing =
    @"desktoppublishing";
static BVContextualInterest *tierTwoTechnologyAndComputingDesktopVideo =
    @"desktopvideo";
static BVContextualInterest *tierTwoTechnologyAndComputingEmail = @"email";
static BVContextualInterest *tierTwoTechnologyAndComputingGraphicsSoftware =
    @"graphicssoftware";
static BVContextualInterest *tierTwoTechnologyAndComputingHomeVideoDVD =
    @"homevideodvd";
static BVContextualInterest *tierTwoTechnologyAndComputingInternetTechnology =
    @"internettechnology";
static BVContextualInterest *tierTwoTechnologyAndComputingJava = @"java";
static BVContextualInterest *tierTwoTechnologyAndComputingJavaScript =
    @"javascript";
...
static BVContextualInterest *tierTwoTechnologyAndComputingMacSupport =
    @"macsupport";
...
static BVContextualInterest *tierTwoTechnologyAndComputingNetConferencing =
    @"netconferencing";
static BVContextualInterest *tierTwoTechnologyAndComputingNetforBeginners =
    @"netforbeginners";
static BVContextualInterest *tierTwoTechnologyAndComputingNetworkSecurity =
    @"networksecurity";
static BVContextualInterest *tierTwoTechnologyAndComputingPalmtopsPDAs =
    @"palmtopspdas";
static BVContextualInterest *tierTwoTechnologyAndComputingPCSupport =
    @"pcsupport";
static BVContextualInterest
    *tierTwoTechnologyAndComputingPortableEntertainment =
        @"portableentertainment";
static BVContextualInterest *tierTwoTechnologyAndComputingSharewareFreeware =
    @"sharewarefreeware";
static BVContextualInterest *tierTwoTechnologyAndComputingUnix = @"unix";
static BVContextualInterest *tierTwoTechnologyAndComputingVisualBasic =
    @"visualbasic";
static BVContextualInterest *tierTwoTechnologyAndComputingWebClipArt =
    @"webclipart";
static BVContextualInterest *tierTwoTechnologyAndComputingWebDesignHTML =
    @"webdesignhtml";
static BVContextualInterest *tierTwoTechnologyAndComputingWebSearch =
    @"websearch";
static BVContextualInterest *tierTwoTechnologyAndComputingWindows = @"windows";

/// Contextual Interests Tier 2: Apparel & Accessories
static BVContextualInterest *tierTwoApparelAndAccessoriesEngagementRings =
    @"engagementrings";
static BVContextualInterest *tierTwoApparelAndAccessoriesFashionJewelry =
    @"fashionjewelry";
static BVContextualInterest *tierTwoApparelAndAccessoriesHairAccessories =
    @"hairaccessories";
static BVContextualInterest *tierTwoApparelAndAccessoriesHandbags = @"handbags";
static BVContextualInterest *tierTwoApparelAndAccessoriesJewelryAndWatches =
    @"jewelryandwatches";
static BVContextualInterest *tierTwoApparelAndAccessoriesMensApparel =
    @"mensapparel";
static BVContextualInterest *tierTwoApparelAndAccessoriesMensAthleticApparel =
    @"mensathleticapparel";
static BVContextualInterest *tierTwoApparelAndAccessoriesMensBusinessAttire =
    @"mensbusinessattire";
static BVContextualInterest *tierTwoApparelAndAccessoriesMensCasualAttire =
    @"menscasualattire";
static BVContextualInterest *tierTwoApparelAndAccessoriesMensShoes =
    @"mensshoes";
static BVContextualInterest *tierTwoApparelAndAccessoriesMensSwimwear =
    @"mensswimwear";
static BVContextualInterest *tierTwoApparelAndAccessoriesSunglasses =
    @"sunglasses";
...
static BVContextualInterest *tierTwoApparelAndAccessoriesWomensShoes =
    @"womensshoes";
static BVContextualInterest *tierTwoApparelAndAccessoriesWomensApparel =
    @"womensapparel";
static BVContextualInterest *tierTwoApparelAndAccessoriesWomensAthleticApparel =
    @"womensathleticapparel";
static BVContextualInterest *tierTwoApparelAndAccessoriesWomensBusinessAttire =
    @"womensbusinessattire";
static BVContextualInterest *tierTwoApparelAndAccessoriesWomensCoatsAndJackets =
    @"womenscoatsandjackets";
static BVContextualInterest *tierTwoApparelAndAccessoriesWomensDresses =
    @"womensdresses";
static BVContextualInterest *tierTwoApparelAndAccessoriesWomensJeans =
    @"womensjeans";
static BVContextualInterest *tierTwoApparelAndAccessoriesWomensMaternity =
    @"womensmaternity";
static BVContextualInterest *tierTwoApparelAndAccessoriesWomensSwimwear =
    @"womensswimwear";
...
static BVContextualInterest *tierTwoPetsVeterinaryMedicine =
    @"veterinarymedicine";
...
static BVContextualInterest *tierTwoCareersResumeWritingAdvice =
    @"resumewritingadvice";
...
static BVContextualInterest *tierTwoShoppingContestsAndFreebies =
    @"contestsandfreebies";
...
static BVContextualInterest *tierTwoAutomotiveBuyingSellingCars =
    @"buyingsellingcars";
static BVContextualInterest *tierTwoAutomotiveCarCulture = @"carculture";
static BVContextualInterest *tierTwoAutomotiveCertifiedPreOwned =
    @"certifiedpreowned";
...
static BVContextualInterest *tierTwoAutomotiveElectricVehicle =
    @"electricvehicle";
...
static BVContextualInterest *tierTwoAutomotiveOffRoadVehicles =
    @"offroadvehicles";
static BVContextualInterest *tierTwoAutomotivePerformanceVehicles =
    @"performancevehicles";
static BVContextualInterest *tierTwoAutomotivePickup = @"pickup";
static BVContextualInterest *tierTwoAutomotiveRoadSideAssistance =
    @"roadsideassistance";
static BVContextualInterest *tierTwoAutomotiveSedan = @"sedan";
static BVContextualInterest *tierTwoAutomotiveTrucksAndAccessories =
    @"trucksandaccessories";
...
static BVContextualInterest *tierTwoPersonalFinanceBeginningInvesting =
    @"beginninginvesting";
static BVContextualInterest *tierTwoPersonalFinanceCreditDebtAndLoans =
    @"creditdebtandloans";
static BVContextualInterest *tierTwoPersonalFinanceFinancialNews =
    @"financialnews";
static BVContextualInterest *tierTwoPersonalFinanceFinancialPlanning =
    @"financialplanning";
...
static BVContextualInterest *tierTwoPersonalFinanceRetirementPlanning =
    @"retirementplanning";
...
static BVContextualInterest *tierTwoHealthAndFitnessAlternativeMedicine =
    @"alternativemedicine";
...
static BVContextualInterest *tierTwoHealthAndFitnessBipolarDisorder =
    @"bipolardisorder";
...
static BVContextualInterest *tierTwoHealthAndFitnessCholesterol =
    @"cholesterol";
static BVContextualInterest *tierTwoHealthAndFitnessChronicFatigueSyndrome =
    @"chronicfatiguesyndrome";
static BVContextualInterest *tierTwoHealthAndFitnessChronicPain =
    @"chronicpain";
...
static BVContextualInterest *tierTwoHealthAndFitnessDermatology =
    @"dermatology";
...
static BVContextualInterest *tierTwoHealthAndFitnessGERDAcidReflux =
    @"gerdacidreflux";
static BVContextualInterest *tierTwoHealthAndFitnessHeadachesMigraines =
    @"headachesmigraines";
static BVContextualInterest *tierTwoHealthAndFitnessHeartDisease =
    @"heartdisease";
static BVContextualInterest *tierTwoHealthAndFitnessHerbsforHealth =
    @"herbsforhealth";
static BVContextualInterest *tierTwoHealthAndFitnessHolisticHealing =
    @"holistichealing";
static BVContextualInterest *tierTwoHealthAndFitnessIBSCrohnsDisease =
    @"ibscrohnsdisease";
static BVContextualInterest *tierTwoHealthAndFitnessIncestAbuseSupport =
    @"incestabusesupport";
static BVContextualInterest *tierTwoHealthAndFitnessIncontinence =
    @"incontinence";
static BVContextualInterest *tierTwoHealthAndFitnessInfertility =
    @"infertility";
...
static BVContextualInterest *tierTwoHealthAndFitnessOrthopedics =
    @"orthopedics";
static BVContextualInterest *tierTwoHealthAndFitnessPanicAnxietyDisorders =
    @"panicanxietydisorders";
static BVContextualInterest *tierTwoHealthAndFitnessPediatrics = @"pediatrics";
static BVContextualInterest *tierTwoHealthAndFitnessPhysicalTherapy =
    @"physicaltherapy";
static BVContextualInterest *tierTwoHealthAndFitnessPsychologyPsychiatry =
    @"psychologypsychiatry";
static BVContextualInterest *tierTwoHealthAndFitnessSeniorHealth =
    @"seniorhealth";
...
static BVContextualInterest *tierTwoHealthAndFitnessSleepDisorders =
    @"sleepdisorders";
static BVContextualInterest *tierTwoHealthAndFitnessSmokingCessation =
    @"smokingcessation";
static BVContextualInterest *tierTwoHealthAndFitnessSubstanceAbuse =
    @"substanceabuse";
static BVContextualInterest *tierTwoHealthAndFitnessThyroidDisease =
    @"thyroiddisease";
static BVContextualInterest *tierTwoHealthAndFitnessWeightLoss = @"weightloss";
static BVContextualInterest *tierTwoHealthAndFitnessWomensHealth =
    @"womenshealth";

/// Contextual Interests Tier 2: News
static BVContextualInterest *tierTwoNewsInternationalNews =
    @"internationalnews";
...
static BVContextualInterest *tierTwoScienceParanormalPhenomena =
    @"paranormalphenomena";
...
static BVContextualInterest *tierTwoArtsAndEntertainmentBooksAndLiterature =
    @"booksandliterature";
static BVContextualInterest *tierTwoArtsAndEntertainmentCelebrityFanGossip =
    @"celebrityfangossip";
...
static BVContextualInterest *tierTwoArtsAndEntertainmentTelevision =
    @"television";

/// Contextual Interests Tier 2: Food & Drink
static BVContextualInterest *tierTwoFoodAndDrinkAmericanCuisine =
    @"americancuisine";
static BVContextualInterest *tierTwoFoodAndDrinkBarbecuesAndGrilling =
    @"barbecuesandgrilling";
static BVContextualInterest *tierTwoFoodAndDrinkCajunCreole = @"cajuncreole";
static BVContextualInterest *tierTwoFoodAndDrinkChineseCuisine =
    @"chinesecuisine";
static BVContextualInterest *tierTwoFoodAndDrinkCocktailsBeer =
    @"cocktailsbeer";
static BVContextualInterest *tierTwoFoodAndDrinkCoffeeTea = @"coffeetea";
static BVContextualInterest *tierTwoFoodAndDrinkCuisineSpecific =
    @"cuisinespecific";
static BVContextualInterest *tierTwoFoodAndDrinkDessertsAndBaking =
    @"dessertsandbaking";
static BVContextualInterest *tierTwoFoodAndDrinkDiningOut = @"diningout";
static BVContextualInterest *tierTwoFoodAndDrinkFoodAllergies =
    @"foodallergies";
static BVContextualInterest *tierTwoFoodAndDrinkFrenchCuisine =
    @"frenchcuisine";
static BVContextualInterest *tierTwoFoodAndDrinkHealthLowFatCooking =
    @"healthlowfatcooking";
static BVContextualInterest *tierTwoFoodAndDrinkItalianCuisine =
    @"italiancuisine";
static BVContextualInterest *tierTwoFoodAndDrinkJapaneseCuisine =
    @"japanesecuisine";
static BVContextualInterest *tierTwoFoodAndDrinkMexicanCuisine =
    @"mexicancuisine";
...
static BVContextualInterest *tierTwoSportsCanoeingKayaking =
    @"canoeingkayaking";
...
static BVContextualInterest *tierTwoSportsFreshwaterFishing =
    @"freshwaterfishing";
...
static BVContextualInterest *tierTwoSportsPowerAndMotorcycles =
    @"powerandmotorcycles";
...
static BVContextualInterest *tierTwoSportsSaltwaterFishing =
    @"saltwaterfishing";
...
static BVContextualInterest *tierTwoSportsSurfingBodyboarding =
    @"surfingbodyboarding";
static BVContextualInterest *tierTwoSportsSwimming = @"swimming";
static BVContextualInterest *tierTwoSportsTableTennisPingPong =
    @"tabletennispingpong";
...
static BVContextualInterest *tierTwoSportsWaterskiWakeboard =
    @"waterskiwakeboard";
...
static BVContextualInterest *tierTwoBusinessBiotechBiomedical =
    @"biotechbiomedical";
static BVContextualInterest *tierTwoBusinessBusinessSoftware =
    @"businesssoftware";
static BVContextualInterest *tierTwoBusinessBusinessSupplies =
    @"businesssupplies";
...
static BVContextualInterest
    *tierTwoReligionandSpiritualityAlternativeReligions =
        @"alternativereligions";
static BVContextualInterest *tierTwoReligionandSpiritualityAtheismAgnosticism =
    @"atheismagnosticism";
static BVContextualInterest *tierTwoReligionandSpiritualityBuddhism =
    @"buddhism";
static BVContextualInterest *tierTwoReligionandSpiritualityCatholicism =
    @"catholicism";
static BVContextualInterest *tierTwoReligionandSpiritualityChristianity =
    @"christianity";
static BVContextualInterest *tierTwoReligionandSpiritualityHinduism =
    @"hinduism";
...
static BVContextualInterest *tierTwoReligionandSpiritualityLatterDaySaints =
    @"latterdaysaints";
static BVContextualInterest *tierTwoReligionandSpiritualityPaganWiccan =
    @"paganwiccan";
...
static BVContextualInterest *tierTwoHomeAndGardenBuildingAndHardware =
    @"buildingandhardware";
static BVContextualInterest *tierTwoHomeAndGardenCoffeeMakers = @"coffeemakers";
static BVContextualInterest *tierTwoHomeAndGardenElectricalAndSolar =
    @"electricalandsolar";
static BVContextualInterest *tierTwoHomeAndGardenEntertaining = @"entertaining";
static BVContextualInterest *tierTwoHomeAndGardenEnvironmentalSafety =
    @"environmentalsafety";
...
static BVContextualInterest *tierTwoHomeAndGardenHeatingCoolingAndAir =
    @"heatingcoolingandair";
...
static BVContextualInterest *tierTwoHomeAndGardenHousekeepingAndOrganization =
    @"housekeepingandorganization";
static BVContextualInterest *tierTwoHomeAndGardenInteriorDecorating =
    @"interiordecorating";
static BVContextualInterest *tierTwoHomeAndGardenKitchenAndDining =
    @"kitchenanddining";
static BVContextualInterest *tierTwoHomeAndGardenLampsAndLighting =
    @"lampsandlighting";
static BVContextualInterest *tierTwoHomeAndGardenLandscaping = @"landscaping";
static BVContextualInterest *tierTwoHomeAndGardenMajorAppliances =
    @"majorappliances";
static BVContextualInterest *tierTwoHomeAndGardenOutdoor = @"outdoor";
static BVContextualInterest *tierTwoHomeAndGardenOutdoorLiving =
    @"outdoorliving";
static BVContextualInterest *tierTwoHomeAndGardenPlumbingAndFixtures =
    @"plumbingandfixtures";
static BVContextualInterest *tierTwoHomeAndGardenRemodelingAndConstruction =
    @"remodelingandconstruction";
static BVContextualInterest *tierTwoHomeAndGardenRugsAndCarpets =
    @"rugsandcarpets";
static BVContextualInterest *tierTwoHomeAndGardenSmallAppliances =
    @"smallappliances";
static BVContextualInterest *tierTwoHomeAndGardenTools = @"tools";
static BVContextualInterest *tierTwoHomeAndGardenWindowTreatments =
    @"windowtreatments";
static BVContextualInterest *tierTwoHomeAndGardenYardAndGarden =
    @"yardandgarden";

/// Contextual Interests Tier 2: Hobbies & Interests
static BVContextualInterest *tierTwoHobbiesAndInterestsArtTechnology =
    @"arttechnology";
static BVContextualInterest *tierTwoHobbiesAndInterestsArtsAndCrafts =
    @"artsandcrafts";
static BVContextualInterest *tierTwoHobbiesAndInterestsBeadwork = @"beadwork";
static BVContextualInterest *tierTwoHobbiesAndInterestsBirdwatching =
    @"birdwatching";
static BVContextualInterest *tierTwoHobbiesAndInterestsBoardGamesPuzzles =
    @"boardgamespuzzles";
static BVContextualInterest *tierTwoHobbiesAndInterestsCandleAndSoapMaking =
    @"candleandsoapmaking";
...
static BVContextualInterest *tierTwoHobbiesAndInterestsCollecting =
    @"collecting";
static BVContextualInterest *tierTwoHobbiesAndInterestsComicBooks =
    @"comicbooks";
static BVContextualInterest *tierTwoHobbiesAndInterestsDrawingSketching =
    @"drawingsketching";
static BVContextualInterest *tierTwoHobbiesAndInterestsFreelanceWriting =
    @"freelancewriting";
static BVContextualInterest *tierTwoHobbiesAndInterestsGenealogy = @"genealogy";
static BVContextualInterest *tierTwoHobbiesAndInterestsGettingPublished =
    @"gettingpublished";
static BVContextualInterest *tierTwoHobbiesAndInterestsGuitar = @"guitar";
static BVContextualInterest *tierTwoHobbiesAndInterestsHomeRecording =
    @"homerecording";
static BVContextualInterest *tierTwoHobbiesAndInterestsInvestorsAndPatents =
    @"investorsandpatents";
static BVContextualInterest *tierTwoHobbiesAndInterestsJewelryMaking =
    @"jewelrymaking";
static BVContextualInterest *tierTwoHobbiesAndInterestsMagicAndIllusion =
    @"magicandillusion";
static BVContextualInterest *tierTwoHobbiesAndInterestsNeedlework =
    @"needlework";
...
static BVContextualInterest *tierTwoHobbiesAndInterestsRoleplayingGames =
    @"roleplayinggames";
static BVContextualInterest *tierTwoHobbiesAndInterestsSciFiAndFantasy =
    @"scifiandfantasy";
static BVContextualInterest *tierTwoHobbiesAndInterestsScrapbooking =
    @"scrapbooking";
static BVContextualInterest *tierTwoHobbiesAndInterestsScreenwriting =
    @"screenwriting";
static BVContextualInterest *tierTwoHobbiesAndInterestsStampsAndCoins =
    @"stampsandcoins";
static BVContextualInterest *tierTwoHobbiesAndInterestsToys = @"toys";
static BVContextualInterest *tierTwoHobbiesAndInterestsVideoAndComputerGames =
    @"videoandcomputergames";
static BVContextualInterest *tierTwoHobbiesAndInterestsWoodworking =
    @"woodworking";

/// Contextual Interests Tier 2: Sporting Goods
static BVContextualInterest *tierTwoSportingGoodsCampingAndHiking =
    @"campingandhiking";
static BVContextualInterest *tierTwoSportingGoodsExerciseAndFitness =
    @"exerciseandfitness";
static BVContextualInterest *tierTwoSportingGoodsIndividualSports =
    @"individualsports";
...
static BVContextualInterest *tierTwoEducationCollegeAdministration =
    @"collegeadministration";
static BVContextualInterest *tierTwoEducationCollegeLife = @"collegelife";
static BVContextualInterest *tierTwoEducationDistanceLearning =
    @"distancelearning";
static BVContextualInterest *tierTwoEducationEnglishasa2ndLanguage =
...
static BVContextualInterest *tierTwoEducationHomeworkStudyTips =
    @"homeworkstudytips";
static BVContextualInterest *tierTwoEducationK6Educators = @"k6educators";
static BVContextualInterest *tierTwoEducationLanguageLearning =
    @"languagelearning";
static BVContextualInterest *tierTwoEducationPrivateSchool = @"privateschool";
static BVContextualInterest *tierTwoEducationSpecialEducation =
    @"specialeducation";
static BVContextualInterest *tierTwoEducationStudyingBusiness =
    @"studyingbusiness";

/// Contextual Interests Tier 2: Consumer Electronics
static BVContextualInterest *tierTwoConsumerElectronicsAudio = @"audio";
static BVContextualInterest *tierTwoConsumerElectronicsBatteriesAndPower =
    @"batteriesandpower";
static BVContextualInterest *tierTwoConsumerElectronicsCableBoxes =
    @"cableboxes";
static BVContextualInterest *tierTwoConsumerElectronicsCarElectronicsAndGPS =
    @"carelectronicsandgps";
static BVContextualInterest *tierTwoConsumerElectronicsCellPhoneCases =
    @"cellphonecases";
static BVContextualInterest *tierTwoConsumerElectronicsCellPhoneChargers =
    @"cellphonechargers";
static BVContextualInterest *tierTwoConsumerElectronicsCellPhoneHeadsets =
    @"cellphoneheadsets";
static BVContextualInterest *tierTwoConsumerElectronicsComputerAccessories =
    @"computeraccessories";
static BVContextualInterest *tierTwoConsumerElectronicsDesktopComputers =
    @"desktopcomputers";
static BVContextualInterest *tierTwoConsumerElectronicsHeadphones =
    @"headphones";
static BVContextualInterest
    *tierTwoConsumerElectronicsHomeNetworkingConnectivity =
        @"homenetworkingconnectivity";
static BVContextualInterest
    *tierTwoConsumerElectronicsInternetAndMediaStreamers =
        @"internetandmediastreamers";
static BVContextualInterest *tierTwoConsumerElectronicsLaptops = @"laptops";
static BVContextualInterest *tierTwoConsumerElectronicsOtherGadgets =
    @"othergadgets";
static BVContextualInterest *tierTwoConsumerElectronicsPrintersAndScanners =
    @"printersandscanners";
static BVContextualInterest *tierTwoConsumerElectronicsSoftware = @"software";
static BVContextualInterest *tierTwoConsumerElectronicsTabletAccessories =
    @"tabletaccessories";
static BVContextualInterest *tierTwoConsumerElectronicsTablets = @"tablets";
static BVContextualInterest *tierTwoConsumerElectronicsTelevisions =
    @"televisions";
static BVContextualInterest *tierTwoConsumerElectronicsVideoGameConsoles =
    @"videogameconsoles";
static BVContextualInterest *tierTwoConsumerElectronicsWearableTechnology =
    @"wearabletechnology";
...
static BVContextualInterest *tierTwoRealEstateBuyingSellingHomes =
    @"buyingsellinghomes";
