...
+ (void)locationManager:(CLLocationManager *)manager
  ...
  [BVLocationEventsHelper didRangeBeacon:beacon
                                inRegion:region
...
+ (NSDictionary *)dictForVisit:(BVGMBLVisit *)visit {
  ...
  [params
      setValue:[[BVAnalyticsManager sharedManager] formatDate:visit.arrivalDate]
        forKey:@"arrivalDate"];
  [params setValue:[[BVAnalyticsManager sharedManager]
...
+ (NSDictionary *)dictForSighting:(BVGMBLSighting *)sighting {
  ...
  [params setValue:[[BVAnalyticsManager sharedManager] formatDate:sighting.date]
            forKey:@"date"];
...
+ (NSDictionary *)getBeaconParams:(CLBeacon *)beacon
...
+ (void)didEnterRegion:(CLCircularRegion *)region
              location:(BVLocationWrapper *)location {
  NSMutableDictionary *eventData = [NSMutableDictionary dictionary];
...
+ (void)didRangeBeacon:(CLBeacon *)beacon
  ...
  [eventData addEntriesFromDictionary:[self getLocationParams:location]];
  [eventData
      addEntriesFromDictionary:[self getBeaconParams:beacon forRegion:region]];
  [eventData addEntriesFromDictionary:@{
    @"cl" : @"Location",
    @"type" : @"Beacon",
    @"source" : @"location-mobile"
